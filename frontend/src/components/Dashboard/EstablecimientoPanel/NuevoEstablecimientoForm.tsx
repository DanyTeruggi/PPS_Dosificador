...
/**
 * Formulario para crear un nuevo establecimiento.
...
export default function NuevoEstablecimientoForm({ onClose }: Props) {
  ...
  const [form, setForm] = useState({
    nombre: "",
    ubicacion: "",
    cliente_id: "", // se ingresa como texto, se envía como número
  });
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      <p className={styles.subtitle}>Completá los datos para registrar un nuevo establecimiento.</p>
